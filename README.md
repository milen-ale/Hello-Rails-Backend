...
**[Hello Rails Frontend]** is a project that serves as the frontend for to display a random message
...
<!-- LIVE DEMO -->
## <img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/ruby-on-rails-icon.png" width="23" height="20"/> Rails frontend <a name="rails-backend"></a>
- Here is the frontend part of the project [Hello React Backend](https://github.com/milen-ale/Hello-Rails-frontend)
